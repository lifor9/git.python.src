...
for mm in range(1,9):
    ...
    fname = "avgmempool_{0}{1}_286.sql".format('19', str(mm).zfill(2))
    f = open(fname, 'w')
    ...
    select_sql = select_sql + "286,_delta,_realtotal0,_realtotal1,_realtotal2,_realtotal3,_realfree0,_realfree1,_realfree2,_realfree3,_numperm0,_numperm1,_numperm2,_numperm3 "
