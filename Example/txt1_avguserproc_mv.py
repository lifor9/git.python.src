...
for mm in range(1,9):
    ...
    fname = "avguserproc_{0}{1}_286.sql.sql".format('19', str(mm).zfill(2))
    f = open(fname, 'w')
    ...
    select_sql = select_sql + "286,_userid,_usr,_sys,_usrsys,_sz,_rss,_vmem,_chario,_processcnt,_threadcnt "
